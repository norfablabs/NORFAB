        ...
        **kwargs: Any,
        ...
        for resolved in resolve_live_vlans(
            ...
            if key not in name_sources:
                ...
                if (
                    source_name.casefold() == automatic_name
                    and observation["name"].casefold() != automatic_name
                ):
                ...
                message = (
                    ...
                    f"'{vlan_live[scope][vid]['name']}' from device '{source_device}'; "
                    f"conflicting device '{conflict_device}' reports VLAN name "
                    f"'{conflict_name}'"
                )
