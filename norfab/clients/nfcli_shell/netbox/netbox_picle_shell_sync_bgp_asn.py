...
from norfab.workers.netbox_worker.netbox_models import SyncBgpAsnInput
...
class SyncBgpAsnShell(
    ...
    devices: Union[List[StrictStr], StrictStr] = Field(
        None,
        description="List of NetBox devices to collect BGP ASNs from",
    )
