...
class TestShellCommon:
    ...
    def test_show_norfab_logging_rejects_service_list_and_removed_filters(self):
    ...
    def test_walk_norfab_files_returns_root_entries(self, monkeypatch):
        monkeypatch.setattr(
            builtins,
            "NFCLIENT",
            FakeNFClient(
    ...
    def test_walk_norfab_files_returns_entries_matching_choice(self, monkeypatch):
        monkeypatch.setattr(
            builtins,
            "NFCLIENT",
            FakeNFClient(
    ...
    def test_nornir_cfg_config_source_returns_entries_matching_choice(
        self, monkeypatch
    ):
        monkeypatch.setattr(
            builtins,
    ...
    def test_nornir_inventory_create_host_from_netbox_shell_submission(
        self, monkeypatch
    ):
        calls = []
