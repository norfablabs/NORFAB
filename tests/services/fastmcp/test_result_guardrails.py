...
class TestFastMCPResultGuardrailsUnit:
    ...
    def test_result_guardrail_model_accepts_supported_rules(self, rule):
    ...
    def test_result_guardrail_model_rejects_invalid_rules(self, rule):
    ...
    def test_result_guardrail_model_compiles_regex(self, rule):
        with pytest.raises(re.error):
            TaskMCPResultGuardrail.model_validate(rule)

    def test_discovery_combines_task_and_matching_inventory_rules(self, monkeypatch):
    ...
    def test_discovery_can_disable_task_result_guardrails(self, monkeypatch):
    ...
    def test_get_tools_includes_result_guardrails(self):
    ...
    def test_replace_updates_nested_strings_without_mutating_raw_result(self):
        raw = {
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "set snmp community junos-secret authorization read-write",
                "junos-secret",
            ),
    ...
    def test_cli_result_guardrails_redact_platform_secrets(self, result, secret):
    ...
    def test_cli_result_guardrails_preserve_snmp_access(self):
    ...
    def test_regex_replaces_only_the_matching_worker_field(self):
        raw = {
    ...
    def test_limit_reconstructs_base_results(self):
    ...
    def test_limit_allows_results_at_the_exact_boundary(self):
    ...
    def test_rules_run_in_authored_order(self):
    ...
    def test_limit_runs_in_authored_order(self):
        ...
        assert (
            apply(raw, [limit, replace])["worker"]["result"] == "a larger replacement"
        )
