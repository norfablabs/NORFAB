...
custom_fields = [
    ...
    {
        "name": "rpl_import_ipv4",
        "label": "IPv4 Import Routing Policies",
        "type": "multiobject",
        "description": "IPv4 import routing policies associated with a VRF",
        "object_types": ["ipam.vrf"],
        "related_object_type": "netbox_bgp.routingpolicy",
    },
    {
        "name": "rpl_import_ipv6",
        "label": "IPv6 Import Routing Policies",
        "type": "multiobject",
        "description": "IPv6 import routing policies associated with a VRF",
        "object_types": ["ipam.vrf"],
        "related_object_type": "netbox_bgp.routingpolicy",
    },
    {
        "name": "rpl_export_ipv4",
        "label": "IPv4 Export Routing Policies",
        "type": "multiobject",
        "description": "IPv4 export routing policies associated with a VRF",
        "object_types": ["ipam.vrf"],
        "related_object_type": "netbox_bgp.routingpolicy",
    },
    {
        "name": "rpl_export_ipv6",
        "label": "IPv6 Export Routing Policies",
        "type": "multiobject",
        "description": "IPv6 export routing policies associated with a VRF",
        "object_types": ["ipam.vrf"],
        "related_object_type": "netbox_bgp.routingpolicy",
    },
    {
